-- =====================================================================
-- SMOKE PRESTAMOS — Flujo completo: crear duplicado falla, cerrar, crear de nuevo
-- Archivo: 2025-10-04_f3_smoke_prestamos.sql
...
BEGIN
  ...
  -- cerrar y re-crear
  PERFORM public.rpc_prestamo_cerrar(v_p1);
