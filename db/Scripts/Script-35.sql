-- =====================================================================
-- F3 · RPC MOVIMIENTOS (COMPLETO · FIX2 enum-safe)
-- Archivo: db/migrations/2025-10-03_01_f3_rpc_movimientos_FIX2.sql
-- ---------------------------------------------------------------------
-- Cambios vs FIX1:
--   • Usa variables tipadas con %TYPE de la tabla para columnas enum/text:
--     objeto_tipo, origen_tipo, destino_tipo, estado.
--   • Comparaciones y updates usan variables tipadas (evita casts y errores).
-- =====================================================================
...
BEGIN
  ...
  -- asignar labels a tipos columna (enum o text)
...
DECLARE
  ...
  v_estado_env  public.movimientos.estado%TYPE := 'enviado';
BEGIN
